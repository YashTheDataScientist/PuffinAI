...
const RobotViewer = ({ onSymptomSelect }) => {
  ...
  const bodyParts = {
    eyes: {
      x1: 57, y1: 20, x2: 61, y2: 25, centerX: 60, centerY: 22,
      title: "Eye Symptoms",
    ...
    nose: {
      x1: 60, y1: 20, x2: 65, y2: 25, centerX: 63, centerY: 23,
    ...
    lungs: {
      x1: 60, y1: 35, x2: 65, y2: 38, centerX: 63, centerY: 35,
    ...
    throat: {
      x1: 60, y1: 25, x2: 64, y2: 30, centerX: 63, centerY: 28,
    ...
    head: {
      x1: 60, y1: 15, x2: 65, y2: 20, centerX: 63, centerY: 17,
      title: "Head Symptoms",
