...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `/images/grass.jpg`, text: 'ryegrass ' },
      { image: `/images/grass1.jpg`, text: 'ryegrass ' },
      { image: `/images/grass3.jpg`, text: 'ryegrass ' },
      { image: `/images/littoralis.jpg`, text: 'Sycamore tree' },
      { image: `/images/littoralis1.jpg`, text: 'Sycamore tree' },
      { image: `/images/littoralis2.jpg`, text: 'Sycamore tree' },
      { image: `/images/littoralis3.jpg`, text: 'Sycamore tree' },
      { image: `/images/betulaceae.jpg`, text: 'betulaceae' }
    ]
  ...
  onTouchMove(e) {
    ...
    const distance = (this.start - x) * 0.001
  ...
  addEventListeners() {
    ...
    window.addEventListener('resize', this.boundOnResize) // 这个仍然保留在window上
