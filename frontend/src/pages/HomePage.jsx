...
// import downArrowAnim from "../assets/downanimate1.json"; // adjust path as needed
...
//             </p>
//             <div className="button-group">
//               {/* <Link to="/symptoms"><button>Understand symptoms</button></Link> */}
...
//       {/* Always show scroll-to-top */}
//       <button className="scroll-top-btn" onClick={() => parallaxRef.current.scrollTo(0)}>
//       ↑
//       </button>
//       <Lottie
...
//         onClick={() => parallaxRef.current.scrollTo(1)} // Optional: scroll on click
//       />
