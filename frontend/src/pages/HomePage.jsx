...
//       {/* SECTION 3 */}
//       <ParallaxLayer offset={2} speed={0} factor={1} style={{ backgroundColor: '#' }} />
...
//             <button onClick={() => window.location.href = '/pollen'}>View Pollen Forecast</button>
...
//           </p>
//           <div className="button-group">
//             <button onClick={() => window.location.href = '/plants'}>Explore & Scan Plants</button>
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('wheel', handleScroll); // show on every scroll
  ...
  return (
    <>
      <Parallax pages={5} ref={parallaxRef}>
        ...
        {/* SECTION 3 */}
        <ParallaxLayer offset={2} speed={0} factor={1} style={{ backgroundColor: '#f5fdf6' }} />
        <ParallaxLayer offset={2} speed={0.2}>
          <div className="image-layer left">
            <img src={Mapsvg} alt="Forest Illustration" />
          </div>
